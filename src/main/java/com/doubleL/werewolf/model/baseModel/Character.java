...
@JsonSubTypes({@JsonSubTypes.Type(value = Human.class, name = "human"), @JsonSubTypes.Type(value = Wolf.class, name =
        "wolf"), @JsonSubTypes.Type(value = BeautyWolf.class, name = "beautyWolf"), @JsonSubTypes.Type(value = Cupid
        .class, name = "cupid"), @JsonSubTypes.Type(value = ElderOfSilence.class, name = "elderOfSilence"),
